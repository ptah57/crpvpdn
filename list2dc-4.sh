...
#
####################################################################
#  Для работы это процедуры требуется скрипт convert2html-4.sh и настрочный файл  dc_list.txt 
#  в каталоге /home/nagios/ с полями вида
...
#      echo " is P[$i] ${P[i]}";
    ...
    /home/nagios/convert2html-4.sh "${P[0]}" "${P[1]}" "${P[2]}" "${P[3]}" 
